...
df = pd.read_json("~/work/ORRmol/cycleFe_func/cycleFe_GeoConv_IntMerge.json")
...
df_gform = pd.read_csv("~/work/ORRmol/dGform_catalysts/cycleFe_gform_IntMerge.csv", index_col=0)
...
print(dfm.columns)
print(dfm[["dGrxn_corr_O2","dGrxn_corr_O2H","dGrxn_corr_O","dGrxn_corr_OH", "dGrxn_corr_regen"]])
dfm.to_json("cycleFe_catcycle_GeoConv_dGrxn.json")
